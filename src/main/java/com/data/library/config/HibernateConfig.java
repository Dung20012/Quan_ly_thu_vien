package com.data.library.config;
...
public class HibernateConfig {
    ...
    public SessionFactory sessionFactory() {
        ...
        sessionBuilder.scanPackages("com.data.library.model.entity"); // package containing your entity classes
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/library_management");// replace with your database URL
